...
internal class DisplayOptionsPanel : XNAOptionsPanel
{
    ...
    public override void Initialize()
    {
        ...
        XNALabel lblIngameResolution = new(WindowManager)
        {
            ...
            Text = "In-game Resolution:".L10N("Client:DTAConfig:InGameResolution")
        };
        ...
        List<ScreenResolution> resolutions = GetResolutions(clientConfig.MinimumIngameWidth,
        ...
        XNALabel lblDetailLevel = new(WindowManager)
        {
            ...
            Text = "Detail Level:".L10N("Client:DTAConfig:DetailLevel")
        };
        ...
        XNALabel lblRenderer = new(WindowManager)
        {
            ...
            Text = "Renderer:".L10N("Client:DTAConfig:Renderer")
        };
        ...
        OSVersion localOS = ClientConfiguration.Instance.GetOperatingSystemVersion();
        ...
        chkWindowedMode = new XNAClientCheckBox(WindowManager)
        {
            ...
            Text = "Windowed Mode".L10N("Client:DTAConfig:WindowedMode")
        };
        ...
        chkBorderlessWindowedMode = new XNAClientCheckBox(WindowManager)
        {
            ...
            Text = "Borderless Windowed Mode".L10N("Client:DTAConfig:BorderlessWindowedMode"),
            AllowChecking = false
        };
        ...
        XNALabel lblClientResolution = new(WindowManager)
        {
            ...
            ClientRectangle = new Rectangle(
            285, 14, 0, 0),
            Text = "Client Resolution:".L10N("Client:DTAConfig:ClientResolution")
        };
        ...
        ddClientResolution = new XNAClientPreferredItemDropDown(WindowManager)
        {
            ...
            ddIngameResolution.Height),
            AllowDropDown = false,
            PreferredItemLabel = "(recommended)".L10N("Client:DTAConfig:Recommended")
        };
        ...
        chkBorderlessClient = new XNAClientCheckBox(WindowManager)
        {
            ...
            Text = "Fullscreen Client".L10N("Client:DTAConfig:FullscreenClient")
        };
        ...
        XNALabel lblClientTheme = new(WindowManager)
        {
            ...
            lblClientResolution.X,
            lblRenderer.Y, 0, 0),
            Text = "Client Theme:".L10N("Client:DTAConfig:ClientTheme")
        };
        ...
        XNALabel lblTranslation = new(WindowManager);
    ...
    private void GetRenderers()
    {
        ...
        IniFile renderersIni = new(SafePath.CombineFilePath(ProgramConstants.GetBaseResourcePath(), RENDERERS_INI));
    ...
    public override void Load()
    {
        ...
        if (renderer.UsesCustomWindowedOption())
        {
            ...
            IniFile rendererSettingsIni = new(SafePath.CombineFilePath(ProgramConstants.GamePath, renderer.ConfigFileName));
    ...
    public override bool Save()
    {
        ...
        {
            IniFile rendererSettingsIni = new(SafePath.CombineFilePath(ProgramConstants.GamePath, selectedRenderer.ConfigFileName));
...
在此之后:
            else : (Height < res2.Height)
*/
                // equal
            {
                    return Height < res2.Height ? -1 : Height > res2.Height ? 1 : 0;
                }
            }

        public override bool Equals(object obj)
        {
            return obj is ScreenResolution resolution && CompareTo(resolution) == 0;
        }
