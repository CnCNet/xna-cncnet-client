...
namespace DTAConfig.OptionPanels
{
    class DisplayOptionsPanel : XNAOptionsPanel
    {
        ...
        private XNAClientDefaultItemDropDown ddClientResolution;
        ...
        public override void Initialize()
        {
            ...
            ddClientResolution = new XNAClientDefaultItemDropDown(WindowManager);
            ...
            ddClientResolution.DefaultItemLabel = "(recommended)";
            ...
            if (optimalWindowedResIndex > -1)
                ddClientResolution.DefaultItemIndex = optimalWindowedResIndex;
