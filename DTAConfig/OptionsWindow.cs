...
public class OptionsWindow : XNAWindow
{
    ...
    public void SetTopBar(XNAControl topBar)
    {
        this.topBar = topBar;
    }
    ...
    private void BtnBack_LeftClick(object sender, EventArgs e)
    {
        ...
        {
            XNAMessageBox msgBox = new(WindowManager, "Downloads in progress".L10N("Client:DTAConfig:DownloadingTitle"),
    ...
    private void SaveSettings()
    {
        ...
        if (restartRequired)
        {
            XNAMessageBox msgBox = new(WindowManager, "Restart Required".L10N("Client:DTAConfig:RestartClientTitle"),
