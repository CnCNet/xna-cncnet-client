...
public class CnCNetManager : IConnectionManager
{
    ...
    public CnCNetManager(WindowManager wm, GameCollection gc, CnCNetUserData cncNetUserData)
    {
        ...
        {
            new("Default color".L10N("Client:Main:ColorDefault"), false, cDefaultChatColor, 0),
            new("Default color #2".L10N("Client:Main:ColorDefault2"), false, cDefaultChatColor, 1),
            new("Light Blue".L10N("Client:Main:ColorLightBlue"), true, Color.LightBlue, 2),
            new("Green".L10N("Client:Main:ColorForestGreen"), true, Color.ForestGreen, 3),
            new("Dark Red".L10N("Client:Main:ColorDarkRed"), true, new Color(180, 0, 0, 255), 4),
            new("Red".L10N("Client:Main:ColorRed"), true, Color.Red, 5),
            new("Purple".L10N("Client:Main:ColorMediumOrchid"), true, Color.MediumOrchid, 6),
            new("Orange".L10N("Client:Main:ColorOrange"), true, Color.Orange, 7),
            new("Yellow".L10N("Client:Main:ColorYellow"), true, Color.Yellow, 8),
            new("Lime Green".L10N("Client:Main:ColorLime"), true, Color.Lime, 9),
            new("Turquoise".L10N("Client:Main:ColorTurquoise"), true, Color.Turquoise, 10),
            new("Sky Blue".L10N("Client:Main:ColorLightSkyBlue"), true, Color.LightSkyBlue, 11),
            new("Blue".L10N("Client:Main:ColorRoyalBlue"), true, Color.RoyalBlue, 12),
            new("Pink".L10N("Client:Main:ColorFuchsia"), true, Color.Fuchsia, 13),
            new("Gray".L10N("Client:Main:ColorLightGray"), true, Color.LightGray, 14),
            new("Gray #2".L10N("Client:Main:ColorGray2"), false, Color.Gray, 15)
        };
    }
    ...
    public bool IsAttemptingConnection => connection.AttemptingConnection;
    ...
    private void DoUserKicked(string channelName, string userName)
    {
        ...
        {
            channel.Users.DoForAllUsers(user => RemoveChannelFromUser(user.IRCUser.Name, channelName));
    ...
    private void DoUserListReceived(string channelName, string[] userList)
    {
        ...
        List<ChannelUser> channelUserList = [];
