...
public class GameLoadingWindow : XNAWindow
{
    ...
    private void BtnLaunch_LeftClick(object sender, EventArgs e)
    {
        ...
        using (StreamWriter spawnStreamWriter = new(spawnerSettingsFile.FullName))
        {
        ...
        using (StreamWriter spawnMapStreamWriter = new(spawnMapIniFile.FullName))
        {
    ...
    {
        SavedGame sg = savedGames[lbSaveGameList.SelectedIndex];
        XNAMessageBox msgBox = new(WindowManager, "Delete Confirmation".L10N("Client:Main:DeleteConfirmationTitle"),
