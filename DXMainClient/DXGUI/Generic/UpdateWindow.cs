...
public class UpdateWindow : XNAWindow
{
    ...
    public override void Initialize()
    {
        ...
        {
            Text = "Progress percentage of current file:".L10N("Client:Main:CurrentFileProgressPercentage"),
        ...
        {
            Text = "Total progress percentage:".L10N("Client:Main:TotalProgressPercentage"),
        ...
        lblUpdaterStatus = new XNALabel(WindowManager)
        {
            ...
            Text = "Preparing".L10N("Client:Main:StatusPreparing"),
