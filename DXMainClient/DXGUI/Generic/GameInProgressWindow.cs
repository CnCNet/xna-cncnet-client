...
public class GameInProgressWindow : XNAPanel
{
    ...
    public override void Initialize()
    {
        ...
        {
            Text = "A game is in progress.".L10N("Client:Main:GameInProgress")
        };
    ...
    private void HandleGameProcessExited()
    {
        ...
        snapshotDirectory ??= SafePath.CombineDirectoryPath(ProgramConstants.GamePath, "debug", FormattableString.Invariant($"snapshot-{dtn:yyyyMMdd-HHmmss}"));
    ...
    private string GetNewestDebugSnapshotDirectory()
    {
        ...
        {
            IEnumerable<string> newDirectories = GetAllDebugSnapshotDirectories().Except(debugSnapshotDirectories);
