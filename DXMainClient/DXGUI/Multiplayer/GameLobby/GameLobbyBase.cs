    ...
    public abstract class GameLobbyBase : XNAWindow
    {
        ...
        protected void ApplyPlayerExtraOptions(string sender, string message)
        {
            ...
            if (playerExtraOptions.IsForceRandomSides != PlayerExtraOptionsPanel.IsForcedRandomSides())
                AddPlayerExtraOptionForcedNotice(playerExtraOptions.IsForceRandomSides, "side");
        ...
        {
            AddNotice($"The game host has {(disabled ? "disabled" : "enabled")} {type} selection");
        }
        ...
        {
            clientDropDown.Enabled = enable;
            if (!clientDropDown.Enabled)
        ...
        protected virtual PlayerHouseInfo[] Randomize(bool overrideGameRandomLocations)
        {
            ...
            for (int i = 0; i < totalPlayerCount; i++)
            {
                ...
                pHouseInfo.RandomizeStart(pInfo, random, freeStartingLocations, takenStartingLocations, overrideGameRandomLocations);
            }
        ...
        private PlayerHouseInfo[] WriteSpawnIni()
        {
            ...
            PlayerHouseInfo[] houseInfos = Randomize(teamStartMappings.Any());
