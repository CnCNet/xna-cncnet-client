    ...
    internal abstract class MultiplayerGameLobby : GameLobbyBase, ISwitchable
    {
            ...
            : base(windowManager, iniName, mapLoader, true, discordHandler)
        {
            ...
            chatBoxCommands = new List<ChatBoxCommand>
            {
                ...
                new("ROLL", "Roll dice, for example /roll 3d6".L10N("UI:Main:ChatboxCommandRollHelp"), false, dieType => RollDiceCommandAsync(dieType).HandleTask()),
                ...
                new("LOADOPTIONS", "Load game option preset".L10N("UI:Main:ChatboxCommandLoadOptionsHelp"), true, presetName => HandleGameOptionPresetLoadCommandAsync(presetName).HandleTask())
            };
