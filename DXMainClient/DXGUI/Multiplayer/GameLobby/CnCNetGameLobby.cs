...
public class CnCNetGameLobby : MultiplayerGameLobby
{
    ...
    private void ApplyPlayerOptions(string sender, string message)
    {
        ...
        for (int i = 0; i < parts.Length;)
        {
            ...
            if (start is < 0 or > MAX_PLAYER_COUNT)
            {
                return;
            }
    ...
    private void BroadcastGame()
    {
        ...
        _ = sb.Append(ProgramConstants.CNCNET_PROTOCOL_REVISION);
        _ = sb.Append(";");
        ...
        _ = sb.Append(";");
        _ = sb.Append(Map.UntranslatedName);
        _ = sb.Append(";");
        _ = sb.Append(GameMode.UntranslatedUIName);
        _ = sb.Append(";");
    ...
    {
        return "Game Lobby".L10N("Client:Main:GameLobby");
    }
}