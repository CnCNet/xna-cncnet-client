...
namespace DTAClient.DXGUI.Multiplayer.GameLobby
{
    public class CnCNetGameLobby : MultiplayerGameLobby
    {
        ...
        {
            connectionManager.SendCustomMessage(new QueuedMessage(
                string.Format("MODE {0} +i +l 1", channel.ChannelName), QueuedMessageType.INSTANT_MESSAGE, -1));
        ...
        {
            connectionManager.SendCustomMessage(new QueuedMessage(
                string.Format("MODE {0} -i +l {1}", channel.ChannelName, playerLimit), QueuedMessageType.INSTANT_MESSAGE, -1));
