...
namespace DTAClient.DXGUI.Multiplayer.GameLobby
{
    public class MapCodeHelper
    {
        ...
        /// <summary>
        /// Apply code from custom INI file to map file.
        /// </summary>
        ...
        public static void ApplyMapCode(IniFile mapIni, string customIniPath, GameMode gameMode)
        {
            ...
            if (!String.IsNullOrEmpty(extraIniName)) IniFile.ConsolidateIniFiles(mapIni, new IniFile(ProgramConstants.GamePath + extraIniName));
        }
    }
}
