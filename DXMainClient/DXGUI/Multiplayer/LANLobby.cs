...
internal class LANLobby : XNAWindow
{
    ...
    private readonly TimeSpan timeSinceGameRefresh = TimeSpan.Zero;
    private EnhancedSoundEffect sndGameCreated;
    private Socket socket;
    private IPEndPoint endPoint;
    private Encoding encoding;
    private readonly List<LANLobbyUser> players = [];
    ...
    public override void Initialize()
    {
        ...
        btnNewGame = new XNAClientButton(WindowManager)
        {
            ...
            Text = "Create Game".L10N("Client:Main:CreateGame")
        };
        ...
        btnJoinGame = new XNAClientButton(WindowManager)
        {
            ...
            Text = "Join Game".L10N("Client:Main:JoinGame")
        };
        ...
        btnMainMenu = new XNAClientButton(WindowManager)
        {
            ...
            btnNewGame.Y, UIDesignConstants.BUTTON_WIDTH_133, UIDesignConstants.BUTTON_HEIGHT),
            Text = "Main Menu".L10N("Client:Main:MainMenu")
        };
        ...
        {
            Name = "lbGameList",
            ClientRectangle = new Rectangle(btnNewGame.X,
        ...
        {
            Name = "lbPlayerList",
            ClientRectangle = new Rectangle(Width - 202,
            lbGameList.Y, 190,
            lbGameList.Height),
            PanelBackgroundDrawMode = PanelBackgroundImageDrawMode.STRETCHED,
            BackgroundTexture = AssetLoader.CreateTexture(new Color(0, 0, 0, 128), 1, 1),
        ...
        {
            Name = "lbChatMessages",
            ClientRectangle = new Rectangle(lbGameList.Right + 12,
            lbGameList.Y,
        ...
        {
            Name = "tbChatInput",
            ClientRectangle = new Rectangle(lbChatMessages.X,
            btnNewGame.Y, lbChatMessages.Width,
            btnNewGame.Height),
            Suggestion = "Type here to chat...".L10N("Client:Main:ChatHere"),
        ...
        lblColor = new XNALabel(WindowManager)
        {
            ...
            FontIndex = 1,
            Text = "YOUR COLOR:".L10N("Client:Main:YourColor")
        };
        ...
        {
            new("Gray".L10N("Client:Main:ColorGray"), Color.Gray),
            new("Metalic".L10N("Client:Main:ColorLightGrayMetalic"), Color.LightGray),
            new("Green".L10N("Client:Main:ColorGreen"), Color.Green),
            new("Lime Green".L10N("Client:Main:ColorLimeGreen"), Color.LimeGreen),
            new("Green Yellow".L10N("Client:Main:ColorGreenYellow"), Color.GreenYellow),
            new("Goldenrod".L10N("Client:Main:ColorGoldenrod"), Color.Goldenrod),
            new("Yellow".L10N("Client:Main:ColorYellow"), Color.Yellow),
            new("Orange".L10N("Client:Main:ColorOrange"), Color.Orange),
            new("Red".L10N("Client:Main:ColorRed"), Color.Red),
            new("Pink".L10N("Client:Main:ColorDeepPink"), Color.DeepPink),
            new("Purple".L10N("Client:Main:ColorMediumPurple"), Color.MediumPurple),
            new("Sky Blue".L10N("Client:Main:ColorSkyBlue"), Color.SkyBlue),
            new("Blue".L10N("Client:Main:ColorBlue"), Color.Blue),
            new("Brown".L10N("Client:Main:ColorSaddleBrown"), Color.SaddleBrown),
            new("Teal".L10N("Client:Main:ColorTeal"), Color.Teal)
        };
    ...
    private void SendAlive()
    {
        ...
        _ = sb.Append(ProgramConstants.LAN_DATA_SEPARATOR);
    ...
    private void LbGameList_DoubleLeftClick(object sender, EventArgs e)
    {
        ...
        try
        {
            TcpClient client = new(hg.EndPoint.Address.ToString(), ProgramConstants.LAN_GAME_LOBBY_PORT);

            byte[] buffer;

            if (hg.IsLoadedGame)
            {
                IniFile spawnSGIni = new(SafePath.CombineFilePath(ProgramConstants.GamePath, ProgramConstants.SAVED_GAME_SPAWN_INI));
