...
public class PlayerExtraOptionsPanel : XNAWindow
{
    ...
    {
        return chkBoxForceRandomSides.Checked;
    }

    public bool IsForcedRandomTeams()
    {
        return chkBoxForceRandomTeams.Checked;
    }

    public bool IsForcedRandomColors()
    {
        return chkBoxForceRandomColors.Checked;
    }

    public bool IsForcedRandomStarts()
    {
        return chkBoxForceRandomStarts.Checked;
    }

    public bool IsUseTeamStartMappings()
    {
        return chkBoxUseTeamStartMappings.Checked;
    }
    ...
    {
        ddTeamStartMappingPreset.AllowDropDown = _isHost && chkBoxUseTeamStartMappings.Checked;
    }
