...
public class LoadOrSaveGameOptionPresetWindow : XNAWindow
{
    ...
    public LoadOrSaveGameOptionPresetWindow(WindowManager windowManager) : base(windowManager)
    {
        ...
        {
            Text = "[Create New]".L10N("Client:Main:CreateNewPreset")
        };

        ddiSelectPresetItem = new XNADropDownItem
        {
            Text = "[Select Preset]".L10N("Client:Main:SelectPreset"),
            Selectable = false
        };
    ...
    {
        XNADropDownItem selectedItem = ddPresetSelect.Items[ddPresetSelect.SelectedIndex];
        XNAMessageBox messageBox = XNAMessageBox.ShowYesNoDialog(WindowManager,
