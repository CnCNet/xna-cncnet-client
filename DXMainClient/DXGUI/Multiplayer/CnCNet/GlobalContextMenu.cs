...
public class GlobalContextMenu : XNAContextMenu
{
    ...
    {
        return contextMenuData.IrcUser != null
            ? contextMenuData.IrcUser
            : contextMenuData.ChannelUser?.IRCUser != null
            ? contextMenuData.ChannelUser.IRCUser
            : !string.IsNullOrEmpty(contextMenuData.PlayerName)
            ? connectionManager.UserList.Find(u => u.Name == contextMenuData.PlayerName)
            : !string.IsNullOrEmpty(contextMenuData.ChatMessage?.SenderName)
            ? connectionManager.UserList.Find(u => u.Name == contextMenuData.ChatMessage.SenderName)
            : null;
    }
