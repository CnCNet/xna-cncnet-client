...
public class MapLoader
{
    ...
    /// </summary>
    private readonly Dictionary<string, string[]> GameModeAliases = [];

    private readonly Dictionary<string, string> _translatedMapNames = [];
    ...
    /// </summary>
    public Task LoadMapsAsync()
    {
        return Task.Run(LoadMaps);
    }
    ...
    public void LoadMaps()
    {
        ...
        IniFile mpMapsIni = new(mpMapsPath);
    ...
    private void LoadMultiMaps(IniFile mpMapsIni)
    {
        ...
        foreach (string key in keys)
        {
            ...
            Map map = new(mapFilePathValue, false);
    ...
    private void CacheCustomMaps(ConcurrentDictionary<string, Map> customMaps)
    {
        ...
        string jsonData = JsonSerializer.Serialize(customMapCache, jsonSerializerOptions);
    ...
    private ConcurrentDictionary<string, Map> LoadCustomMapCache()
    {
        try
        {
            ...
            CustomMapCache customMapCache = JsonSerializer.Deserialize<CustomMapCache>(jsonData, jsonSerializerOptions);
