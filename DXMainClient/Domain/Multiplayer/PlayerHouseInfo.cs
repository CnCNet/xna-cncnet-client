...
public class PlayerHouseInfo
{
    ...
    /// </summary>
    public int InternalSideIndex => IsSpectator && !string.IsNullOrEmpty(ClientConfiguration.Instance.SpectatorInternalSideIndex)
                ? int.Parse(ClientConfiguration.Instance.SpectatorInternalSideIndex)
                : !string.IsNullOrEmpty(ClientConfiguration.Instance.InternalSideIndices)
                ? Array.ConvertAll(ClientConfiguration.Instance.InternalSideIndices.Split(','), int.Parse)[SideIndex]
                : SideIndex;
