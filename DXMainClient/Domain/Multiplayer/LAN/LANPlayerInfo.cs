...
public class LANPlayerInfo : PlayerInfo
{
    ...
    public bool Update(GameTime gameTime)
    {
        ...
        return TimeSinceLastReceivedMessage <= TimeSpan.FromSeconds(DROP_TIMEOUT);
    }

    public override string IPAddress
    {
        get => TcpClient != null ? ((IPEndPoint)TcpClient.Client.RemoteEndPoint).Address.ToString() : base.IPAddress;

        set => base.IPAddress = value;//throw new InvalidOperationException("Cannot set LANPlayerInfo's IPAddress!");
    }
