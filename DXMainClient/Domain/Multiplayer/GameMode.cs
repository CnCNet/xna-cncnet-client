...
public class GameMode
{
    ...
    {
        IniFile forcedOptionsIni = new(SafePath.CombineFilePath(ProgramConstants.GamePath, ClientConfiguration.Instance.MPMapsIniPath));
    ...
    protected bool Equals(GameMode other)
    {
