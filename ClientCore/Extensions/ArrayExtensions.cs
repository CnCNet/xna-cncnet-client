...
public static class ArrayExtensions
{
    ...
    {
        return @this == null || @this.Length < 2 ? throw new ArgumentException(null, nameof(@this)) : (@this[0], @this[1]);
    }
    ...
    {
        return @this == null || @this.Length < 3 ? throw new ArgumentException(null, nameof(@this)) : (@this[0], @this[1], @this[2]);
    }
    ...
    {
        return @this == null || @this.Length < 7
            ? throw new ArgumentException(null, nameof(@this))
