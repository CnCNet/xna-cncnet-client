...
public static class ProgramConstants
{
    ...
    {
        return aiLevel > -1 && aiLevel < AI_PLAYER_NAMES.Count ? AI_PLAYER_NAMES[aiLevel] : "";
    }
    ...
    public static List<string> AI_PLAYER_NAMES => ["Easy AI".L10N("Client:Main:EasyAIName"), "Medium AI".L10N("Client:Main:MediumAIName"), "Hard AI".L10N("Client:Main:HardAIName")];
