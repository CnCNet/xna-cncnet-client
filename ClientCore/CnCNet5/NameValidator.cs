...
public static class NameValidator
{
    ...
    public static string IsNameValid(string name)
    {
        ...
        return name.Length > ClientConfiguration.Instance.MaxNameLength
            ? "Your nickname is too long.".L10N("Client:ClientCore:NameTooLong")
            : null;
    }
    ...
    public static string GetValidOfflineName(string name)
    {
        ...
        return validName.Length > ClientConfiguration.Instance.MaxNameLength
            ? validName[..ClientConfiguration.Instance.MaxNameLength]
            : validName;
    }
}