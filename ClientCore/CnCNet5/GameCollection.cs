    ...
    public class GameCollection
    {
        ...
        public void Initialize()
        {
            ...
            CnCNetGame[] defaultGames =
            {
                new()
                {
                    ChatChannel = "#cncnet-pr",
                    ClientExecutableName = "PRLauncher.exe",
                    GameBroadcastChannel = "#cncnet-pr-games",
                    InternalName = "pr",
                    RegistryInstallPath = "HKCU\\Software\\ProjectRushConquer",
                    UIName = "Project Rush: Conquer".L10N("Client:Core:ProjectRushConquer"),
                    Texture = AssetLoader.TextureFromImage(prIcon)
                }
            };
