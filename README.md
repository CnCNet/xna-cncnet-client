...
Building the solution for **any** platform requires Visual Studio 2022 17.14 or newer and/or the .NET SDK 10.0.100. A modern version of Visual Studio Code, MonoDevelop or Rider could also work, but are not officially supported.
