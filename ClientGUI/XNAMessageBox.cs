...
namespace ClientGUI
{
    ...
    public class XNAMessageBox : XNAWindow
    {
        ...
        private void AddOKButton()
        {
            ...
            btnOK.Name = "btnOK";
            btnOK.Text = "OK".L10N("Client:ClientGClient:ButtonOK");
        ...
        private void AddYesNoButtons()
        {
            ...
            btnYes.Name = "btnYes";
            btnYes.Text = "Yes".L10N("Client:ClientGClient:ButtonYes");
            ...
            btnNo.Name = "btnNo";
            btnNo.Text = "No".L10N("Client:ClientGClient:ButtonNo");
        ...
        private void AddOKCancelButtons()
        {
            ...
            btnCancel.Text = "Cancel".L10N("Client:ClientGClient:ButtonCancel");
