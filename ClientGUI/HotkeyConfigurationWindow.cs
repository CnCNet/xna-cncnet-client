...
namespace ClientGUI
{
    ...
    public class HotkeyConfigurationWindow : XNAWindow
    {
        ...
        private sealed record Hotkey
        {
            ...
            {
                Key = GetTSKeyOverride((Keys)(encodedKeyValue & 255));
            ...
            /// </summary>
            private static Keys GetTSKeyOverride(Keys key)
            {
                // 12 is actually NumPad5 for the game
                // Note: this is the ONLY differences. The default configuration file generated by the game uses 12 for NumPad5.
                // And we don't need to map Keys.NumPad back to 12 because the game can correctly read the Windows virtual keycode for NumPad5, 101.
            ...
            {
                // Note: we do not need to map Keys.NumPad5 back to 12 because the game can correctly read the Windows virtual keycode for NumPad5, 101.
