...
internal class Parser
{
    ...
    public static Parser Instance { get; }
    ...
    private XNAControl GetControl(string controlName)
    {
        ...
        return control ?? throw new KeyNotFoundException($"Control '{controlName}' not found while parsing input '{Input}'");
    }
    ...
    {
        return tokenPlace >= Input.Length;
    }
}