...
public static class TranslationGUIExtensions
{
    ...
    public static string LookUp(this Translation @this, XNAControl control, string attributeName, string defaultValue, TranslationNotificationLevel notificationLevel)
    {
